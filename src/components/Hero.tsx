      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-10">
        <div className="grid items-center gap-12 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            >
              Saya <strong className="text-coffee">Roedy Rustam</strong> — Praktisi Pertanian dan
              Pegiat Adat yang menemani petani kopi Sulawesi dari bukit Toraja sampai ke meja

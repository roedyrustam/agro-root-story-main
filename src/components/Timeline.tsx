...
const milestones = [
  ...
  {
    year: "2024 — 2026",
    title: "Trainer UMKM & Konsultan Strategis",
    desc: "Membidani lahirnya ekosistem ekonomi digital di 7 wilayah dampingan. Mengintegrasikan standar SCA CVA 2025 ke kurikulum pelatihan petani dan membangun infrastruktur cloud untuk BUMDes.",
    tag: "Consulting",
    chapter: "II",
  },
  {
    ...
    desc: "Mengelola operasional hulu-hilir kopi di Barru, Toraja, dan Sinjai. Menjamin kualitas 'Single Origin' melalui digitalisasi profil rasa (CuppingNotes).",
    tag: "Operations",
    chapter: "II",
  },
  {
    year: "2026",
    title: "Pusat Ekonomi Nasional (Jakarta)",
    desc: "Ekspansi koridor ekonomi hulu-hilir dengan membuka akses pasar strategis di Jakarta bagi produk kopi specialty Sulawesi Selatan.",
    tag: "Market Access",
    chapter: "II",
  },
  {
    ...
    <section id="journey" className="border-t border-border bg-cream-soft py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        ...
        <ol className="relative mt-20 space-y-12 md:mt-24">
          <span className="absolute left-[8px] top-2 bottom-2 w-px origin-top bg-coffee/15 md:left-1/2 md:-translate-x-1/2" />

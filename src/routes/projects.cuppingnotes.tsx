          ...
          <div className="grid gap-16 md:grid-cols-12 md:gap-8">
            ...
            <div className="space-y-16 md:col-span-8 md:col-start-6 lg:col-span-7">
              <article className="prose prose-stone max-w-none prose-p:leading-relaxed prose-p:text-coffee/80 prose-headings:font-display prose-headings:text-coffee prose-strong:text-terracotta">
                ...
                <p>
                  Evaluasi kualitas kopi (cupping) adalah proses vital bagi roaster dan Q-Grader. Namun, 
                  pencatatan manual di atas kertas menyulitkan rekapitulasi data, kolaborasi, dan pembagian 
                  hasil evaluasi profil rasa kepada stakeholders lain.
                </p>

                <h2>Tantangan Sistem</h2>
                <p>
                  Aplikasi membutuhkan interaksi mobile yang sangat stabil saat digunakan di lapangan, dengan
                  data integrity yang kuat agar manipulasi metrik sosial (seperti rating atau ulasan) tidak terjadi.
                  Selain itu, pengguna menginginkan kemampuan membagikan hasil cupping mereka secara estetik
                ...
                <div className="my-8 grid gap-6 sm:grid-cols-2">
                  <div className="rounded-2xl bg-cream-soft p-6">
                    ...
                    <p className="mb-0 text-sm opacity-80">
                      Penggunaan Angular 21 Signals untuk reaktivitas UI tingkat tinggi, menjamin state
                      tidak rusak walau koneksi terputus sesaat.
                    </p>
                  </div>
                  <div className="rounded-2xl bg-cream-soft p-6">
                  ...
                  <div className="rounded-2xl bg-cream-soft p-6">
                    ...
                    <p className="mb-0 text-sm opacity-80">
                      Implementasi SSR (Server-Side Rendering) untuk meng-generate Open Graph meta tags dinamis 
                      berisi preview hasil cupping.
                    </p>
                  </div>
                  <div className="rounded-2xl bg-cream-soft p-6">
                    <h4 className="mt-0 font-display text-xl">Image Processing</h4>
                    <p className="mb-0 text-sm opacity-80">
                      Sistem yang dapat mengolah data skor numerik menjadi radar chart visual 
                      untuk langsung dianalisis oleh roaster.
                    </p>
                  </div>
                </div>
                ...
                <p>
                  ...
                  produksi yang ter-harden. Proses cupping tidak lagi berhenti di atas meja laboratorium,
                  tetapi terdokumentasi rapi, aman, dan siap dibagikan ke ranah publik.
                </p>
              </article>
            </div>
          </div>
